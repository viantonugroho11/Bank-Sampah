...
<body>
    ...
    if ($level) {
        ...
        ?>
            ...
            <li>
                <a href="admin.php?page=data-nasabah-full"><span class="fa fa-users" aria-hidden="true"></span>Data
                    Nasabah</a>
            </li>
            ...
            <li>
                <a href="admin.php?page=data-setor"><span class="fa fa-handshake-o" aria-hidden="true"></span>Transaksi
                    Setor</a>
            </li>
            ...
            <li>
                <a href="admin.php?page=data-artikel"><span class="fa fa-photo" aria-hidden="true"></span>Data Artikel</a>
            </li>
                    ...
                    if (isset($_GET['page'])) {
                        ...
                        switch ($page) {
                            case 'data-admin':
                                ...
                                break;
                            case 'data-artikel':
                                include "../system/function/view-artikel.php";
                                break;
                            case 'tambah-data-artikel':
                                include "../system/function/tambah-artikel.php";
                                break;
                            case 'edit-artikel':
                                include "../system/function/edit-artikel.php";
                                break;
