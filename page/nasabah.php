...
<body>
    <div class="sidebar">
        <ul>
            <li>
                <a href="nasabah.php?page=data-nasabah"
                    style="text-align: center; padding: 30px 0 30px 0; font-size: 20px;">Nasabah <?php echo $row[
                        'nama'
                    ]; ?></a>
            </li>

            <li>
                <a href="nasabah.php?page=data-sampah-n"><span class="fa fa-trash" aria-hidden="true"></span>Data
                    Sampah</a>
            </li>

            <li>
                <a href="nasabah.php?page=histori-setor"><span class="fa fa-handshake-o"
                        aria-hidden="true"></span>Histori Setor</a>
            </li>
