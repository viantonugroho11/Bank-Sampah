    ...
    $(document).ready(function() { // Ketika halaman sudah diload dan siap
        $("#btn-tambah-form").click(function() { // Ketika tombol Tambah Data Form di klik
            ...
            $("#insert-form").append("<b>Data ke " + nextform + " :</b>" +
                ...
                "<div class='form-group'><label class=''>Nomor Induk Nasabah</label><select class='nomornasabah' name='nin' ><option value='pnin'>---Pilih NIN---</option><?php
                ...
                "<div class='form-group'><label class=''>Harga Sampah (Rp)</label><input type='text' placeholder='tomatis terisi' style='cursor: not-allowed;' id='harga2'name='harga2'value='" +
                hargatotal + " onkeyup='sum();' readonly /></div>" +
                ...
                "<div class='form-grou'><label class=''>Nomor Induk Admin</label><input type='text' style'cursor: not-allowed;' name='nia'value='<?php echo $_SESSION[
                    'nia'
                ]; ?>' readonly /></div>" +
