        ...
        while ($row = mysqli_fetch_assoc($query)) {
            ...
            <tr align="center">
                ...
                <td>
                    ...
                    <a href="admin.php?page=edit-admin-id&id=<?php echo $row[
                    'nia'
                ]; ?>">
                        <button><i class="fa fa-pencil"></i>edit</button>
                    </a>

                    <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="../system/function/delete-admin.php?id=<?php echo $row[
                    'nia'
                ]; ?>">
