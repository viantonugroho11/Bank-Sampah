...
<body>
  ...
  <div class="form-group">
    ...
    <input type="text" style="cursor: not-allowed;" disabled="disabled"
      value="<?php echo @$_SESSION['nin']; ?>" />
  </div>
  <div class="form-group">
    <label class="">Nama Nasabah</label>
    <input type="text" style="cursor: not-allowed;" disabled="disabled"
      value="<?php echo @$_SESSION['nama_n']; ?>" />
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" style="cursor: not-allowed;" disabled="disabled"
      value="<?php echo @$_SESSION['telepon_n']; ?>" />
  </div>
  <div class="form-group">
    <label class="">E-mail</label>
    <input type="text" style="cursor: not-allowed;" disabled="disabled"
      value="<?php echo @$_SESSION['email_n']; ?>" />
  </div>
  <div class="form-group">
    <label class="">Password</label>
    <input type="password" style="cursor: not-allowed;" disabled="disabled"
      value="<?php echo @$_SESSION['pass_n']; ?>" />
  </div>
  <div class="form-group">
