...
<body>
    ...
    <table id="example" class="display" cellspacing="0" width="100%" border="0">
        ...
        $no = 0;
            $query = mysqli_query(
                $conn,
                'SELECT * FROM tarik ORDER BY id_tarik ASC'
            );
            ...
            <tr align="center">
                ...
                <td>
                    ...
                    <a
                        href="admin.php?page=edit-tarik&id=<?php echo $row['id_tarik']; ?>">
                        <button><i class="fa fa-pencil"></i>edit</button>
                    </a>

                    <a onclick="return confirm('Anda yakin ingin menghapus data ini?')" href="../system/function/delete-tarik.php?id=<?php echo $row[
                        'id_tarik'
                    ]; ?>">
